...
internal class GridRVAdapter(
    ...
    private lateinit var text_datail: TextView
    ...
    override fun getView(position: Int, convertView: View?, parent: ViewGroup?): View? {
        ...
        text_datail = convertView!!.findViewById(R.id.textView)
        ...
        text_datail.setText(courseList.get(position).Detail)
        Glide.with(this.context).load(courseList.get(position).courseImg).into(courseIV);
